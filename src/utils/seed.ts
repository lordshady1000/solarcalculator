...
const SEED_APPLIANCES = [
  ...
  { name:"Air Conditioner (1HP)",defaultWattage:1000,category:"Cooling",icon:"❄️" },
  { name:"Air Conditioner (1.5HP)",defaultWattage:1500,category:"Cooling",icon:"❄️" },
  { name:"Air Conditioner (2HP)",defaultWattage:2000,category:"Cooling",icon:"❄️" },
  ...
  { name:"Water Pump",defaultWattage:750,category:"Utility",icon:"💧" },
